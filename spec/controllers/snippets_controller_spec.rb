...
describe SnippetsController do
  ...
  let(:valid_attributes) { { "parent_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved snippet as @snippet" do
        ...
        post :create, {:snippet => { "parent_id" => "invalid value" }}, valid_session
        assigns(:snippet).should be_a_new(Snippet)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested snippet" do
        ...
        Snippet.any_instance.should_receive(:update).with({ "parent_id" => "1" })
        put :update, {:id => snippet.to_param, :snippet => { "parent_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the snippet as @snippet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Snippet.any_instance.stub(:save).and_return(false)
        put :update, {:id => snippet.to_param, :snippet => { "parent_id" => "invalid value" }}, valid_session
        assigns(:snippet).should eq(snippet)
      end
